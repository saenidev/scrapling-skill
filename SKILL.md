...
**Key capabilities:** HTTP/browser fetching, Cloudflare bypass, adaptive selectors, CLI tools, MCP server for AI agents.
...
```python
# CSS (recommended)
page.css('.class')              # Multiple
page.css_first('.class')        # Single
page.css('.title::text')        # Text extraction
page.css('a::attr(href)')       # Attribute
...
page = Selector(html)
content = page.css_first('.item').text
```
